Heart Ranked or heartranked is a combo, heart and remixed based publishing platform with live MARKDOWN HTML editor built on web.py for the world wide web.
...
ANDROID TERMUX TROUBLESHOOTING COMING SOON.
